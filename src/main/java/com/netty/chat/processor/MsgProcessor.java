...
public class MsgProcessor
{
    ...
    //群发图片
    public void sendMsg(Channel client, BinaryWebSocketFrame msg)
    {
        ...
        {
            byteBufList.add( byteBuf.copy());
        }
        int k = 0;
        for (Channel channel : onlineUsers)
        {
            channel.writeAndFlush(new BinaryWebSocketFrame(byteBufList.get(k)));
            k++;
        }
    }
}
